...
insert  into `catalogue_contact`(`id`,`name`,`email_add`,`message`,`created_date`) values (1,'Avik','avik@yhaoo.com','','2018-02-19 10:50:23'),(2,'bunho','buno@ymail.com','','2018-02-19 13:07:16'),(3,'Ts','pentasoft.programmer@gmail.com','','2018-02-19 14:00:34'),(4,'Piono Ghosh','pentabits.dev@gmail.com','message  vestibulum mauris at velit placerat, ac feugiat ex volutpat. Vestibulum accumsan, est id venenatis hendrerit, dui tortor varius turpis, eget scelerisque ligula risus in risus','2018-02-19 14:02:02');
...
insert  into `ci_sessions`(`session_id`,`ip_address`,`user_agent`,`last_activity`,`user_data`) values ('9764070f368a744c1443dcdab91653c3','127.0.0.1','Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:58.0) Gecko/20100101 Firefox/58.0',1519029033,'');
...
insert  into `users`(`userid`,`login`,`password`,`loginip`,`logintime`,`joburl`,`isActive`) values (1,'admin','pentabits','127.0.0.1','2018-02-15 11:16:22','admin','Y'),(2,'demo','demo@1980','127.0.0.1','2017-11-29 17:08:47',NULL,'Y');
